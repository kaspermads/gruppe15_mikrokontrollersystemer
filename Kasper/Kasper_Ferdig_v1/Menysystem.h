...
void printOverview()
{
	...
	printf("OVERVIEW \r\n");
	printf("\r\n");
	printf("Fan 1 rpm: %d\r\n", (fan[1].State == OFF) ? 0 : fan[1].rpm);
	printf("Fan 1 state: %s\r\n",  fanStates[fan[1].State].name);
	printf("Fan 2 rpm: %d\r\n", (fan[2].State == OFF) ? 0 : fan[2].rpm);
	printf("Fan 2 state: %s\r\n", fanStates[fan[2].State].name);
	printf("Fan 3 rpm: %d\r\n", (fan[3].State == OFF) ? 0  :fan[3].rpm);
	printf("Fan 3 state: %s\r\n", fanStates[fan[3].State].name);
	printf("Fan 4 rpm: %d\r\n", (fan[4].State == OFF) ? 0 : fan[4].rpm);
	printf("Fan 4 state: %s\r\n", fanStates[fan[4].State].name);
