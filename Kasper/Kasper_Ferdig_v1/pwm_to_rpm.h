...
/**
 * @brief Returns the average of an array
 * 
 * @param array Expects the tach data array
 * @param size Expects the size of the tach data array
 * 
